...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ["React", "Angular", "Node.js", "Spring Boot", "Flask", "Microservices" ],
  },
  ...
  {
    title: "Tools",
    skills: ["Git", "Figma", "Postman", "Jira", "Apache Airflow", "Cursor"],
  },
  {
    title: "AI & Machine Learning",
    skills: ["OpenAI API", "Claude API", "NLP", "Computer Vision", "PyTorch",  "Tensorflow"],
  },
];
