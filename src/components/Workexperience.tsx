...
const timelineData: TimelineItem[] = [
  {
    ...
    period: "2024 - Present",
    description: "Founding engineer behind an AI-powered language learning platform. Owned the full stack from Figma to production, a responsive Angular frontend on PostgreSQL + Firebase, AWS cloud infrastructure (EC2 + Amplify, CI/CD), and real-time speech processing through Azure Speech Services.",
    type: "work",
  },
  {
    id: 2,
    ...
    period: "2024 - 2025",
    description: "Specialized in Software Engineering and Machine Learning, graduated with honors. Coursework across DSA, DAA, Operating Systems, NLP, and Computer Vision. Thesis on Computer Vision with TransGAN architecture.",
    type: "education",
  },
  {
    id: 3,
    ...
    period: "2021 - 2023",
    description: "Contributed to a standardized deployment framework that automated application releases across data and backend systems, and led the migration of the core UI from .NET to React. Worked closely with data teams to enhance backend APIs and frontend integrations and to automate data workflows using Apache Airflow.",
    type: "work",
  },
  {
    id: 4,
